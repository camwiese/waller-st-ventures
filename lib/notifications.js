          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; background: #ffffff;">
            ...
            <div style="padding: 28px; border-left: 1px solid ${EMAIL.border}; border-right: 1px solid ${EMAIL.border};">
              ...
              <div style="margin-top: 24px;">
                <a href="${adminUrl}/admin" style="display: inline-block; background: ${EMAIL.buttonBg}; color: #ffffff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">View Analytics</a>
              </div>
            </div>
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; background: #ffffff;">
      ...
      <div style="padding: 28px; border-left: 1px solid ${EMAIL.border}; border-right: 1px solid ${EMAIL.border};">
        ...
        <div style="display: flex; gap: 12px;">
          <a href="${approveUrl}" style="display: inline-block; background: ${EMAIL.buttonBg}; color: #ffffff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">Approve</a>
...
export async function sendInviteEmail(email, type = "invite", options = {}) {
  ...
  const baseUrl = (process.env.NEXT_PUBLIC_APP_URL || "https://waller-street-ventures.vercel.app").replace(/\/+$/, "");
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; background: #ffffff;">
        ...
        <div style="padding: 28px; border-left: 1px solid ${EMAIL.border}; border-right: 1px solid ${EMAIL.border};">
          ...
          <a href="${loginUrl}" style="display: inline-block; background: ${EMAIL.buttonBg}; color: #ffffff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 600;">${isApproval ? "Go to code entry" : "Log in to view"}</a>
